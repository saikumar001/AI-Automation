...
- **Docs lookup:** `skills/official-docs-lookup/SKILL.md`
...
- **Social posting**: Optimized content (hashtag suggestions, emoji placement, length)
- **Media support**: Image upload (LinkedIn: up to 9 images; Twitter: up to 4)
- **Link previews**: Auto‑generated by platforms
- **Docs lookup**: Fast retrieval from official sources with summarization
